const PREGUNTAS = {
  ...
  sociohabitacional: [
    ...
    },
    {
      ...
      type: 'chips_otros',
      required: false,
      options: ['Trabajo', 'Salud', 'Vivienda', 'Educación', 'Transporte',
        'Seguridad', 'Cultura y deporte', 'Espacios verdes', 'Pavimento', 'Cloacas'],
      otrosPlaceholder: 'Otras necesidades…',
    },
    {
      ...
      type: 'chips_otros',
      required: false,
      options: ['Empleo', 'Salud', 'Vivienda', 'Educación', 'Deporte',
        'Cultura', 'Asistencia social', 'Obras públicas', 'Medio ambiente', 'Juventud'],
      otrosPlaceholder: 'Otros programas…',
    },
    {
      id: 'voto',
      label: '¿Nos votaría?',
